# Proxy
This is the newly developed player data architecture for Inferris that works with the Inferris [REST API]([https://github.com](https://github.com/inferris-com/InferrisAPI) microservice. This will be integrated into the private proxy plugin's current architecture.
